...
COMPONENT_SCHEMA: dict[str, Any] = {
    ...
    "properties": {
        ...
        "sources": {"type": "array", "items": {"$ref": "#/$defs/source_document"}},
    ...
    "$defs": {
        ...
        "source_document": {
            "type": "object",
            "additionalProperties": False,
            "required": ["source_id", "title", "kind", "sha256", "retention_mode"],
            "properties": {
                "source_id": {"type": "string", "minLength": 1},
                "title": {"type": "string", "minLength": 1},
                "kind": {"type": "string", "minLength": 1},
                "sha256": {"type": "string", "pattern": "^[0-9a-f]{64}$"},
                "retention_mode": {"type": "string", "enum": ["embedded", "external_reference", "restricted", "local_only"]},
                "document_revision": {"type": "string"},
                "retrieval_date": {"type": "string", "pattern": "^\\d{4}-\\d{2}-\\d{2}$"},
                "uri": {"type": "string"},
